...
// The payload of the benchmarks of bytedance/sonic ( testdata/twitter.go of sonic v1.15.4 ), copied as it is:
// a directory named testdata can't be imported. The benchmarks which go with it are in sonic_twitter_bench_test.go.
